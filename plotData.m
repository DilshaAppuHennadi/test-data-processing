function [outTE_W1, outTM_W1] = plotData(TE_wg,TE_in,TM_wg,TM_in, PhCTE, PhCTM, W1TE, W1TM, name)
    ...
    A = importdata(PhCTE);
    power_PhC_TE = A(:,2); % mW
    powerdB_PhC_TE = 10*log10(power_PhC_TE) - (-1) - TE_wg - TE_in; % dBm
    ...
    C = importdata(W1TE);
    power_W1_TE = C(:,2); % mW
    powerdB_W1_TE = 10*log10(power_W1_TE) - (-1) - TE_wg - TE_in; % dBm
